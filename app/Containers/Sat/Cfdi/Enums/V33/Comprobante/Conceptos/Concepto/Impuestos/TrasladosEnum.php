...
namespace App\Containers\Sat\Cfdi\Enums\V33\Comprobante\Conceptos\Concepto\Impuestos;
...
enum TrasladosEnum: string implements Contracts\SimpleTypeEnumContract
{
    use Options;
