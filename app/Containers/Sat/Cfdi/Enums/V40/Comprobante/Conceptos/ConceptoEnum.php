...
namespace App\Containers\Sat\Cfdi\Enums\V40\Comprobante\Conceptos;
...
enum ConceptoEnum: string implements SimpleTypeEnumContract
{
    use Options;
    ...
    public function annotation(): string
    {
        return match($this)
        {
            ...
            ConceptoEnum::ObjetoImp        => 'Atributo requerido para expresar si la operación comercial es objeto o no de impuesto.',
        };
    }
    ...
    public function base(): BaseEnum
    {
        return match($this)
        {
            ...
            ConceptoEnum::ObjetoImp        => Types\CatCFDIEnum::C_ObjetoImp->base(),
        };
    }
    ...
    public function restrictionRules(): array
    {
        return match($this)
        {
            ...
            ConceptoEnum::ObjetoImp        => Types\CatCFDIEnum::C_ObjetoImp->restrictionRules(),
        };
    }
}
