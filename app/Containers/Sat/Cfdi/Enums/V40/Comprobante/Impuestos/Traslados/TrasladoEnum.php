...
namespace App\Containers\Sat\Cfdi\Enums\V40\Comprobante\Impuestos\Traslados;
...
enum TrasladoEnum: string implements Contracts\SimpleTypeEnumContract
{
    ...
    public function annotation(): string
    {
        return match($this)
        {
            TrasladoEnum::Base       => 'Atributo requerido para señalar la suma de los atributos Base de los conceptos del impuesto trasladado. No se permiten valores negativos.',
            ...
            TrasladoEnum::TasaOCuota => 'Atributo condicional para señalar el valor de la tasa o cuota del impuesto que se traslada por los conceptos amparados en el comprobante.',
            TrasladoEnum::Importe    => 'Atributo condicional para señalar la suma del importe del impuesto trasladado, agrupado por impuesto, TipoFactor y TasaOCuota. No se permiten valores negativos.',
        };
    }
    ...
    public function base(): BaseEnum
    {
        return match($this)
        {
            TrasladoEnum::Base       => Types\TdCFDIEnum::T_Importe->base(),
    ...
    public function restrictionRules(): array
    {
        return match($this)
        {
            TrasladoEnum::Base       => Types\TdCFDIEnum::T_Importe->restrictionRules(),
