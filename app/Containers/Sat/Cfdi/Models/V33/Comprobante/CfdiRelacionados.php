...
use App\Containers\Sat\Cfdi\Models\V33\Comprobante\CfdiRelacionados as CfdiRelacionadosModels;
...
use App\Containers\Sat\Cfdi\Values\V33\Elements\Comprobante\CfdiRelacionadosElement;
...
class CfdiRelacionados extends Model
{
    ...
    protected $collection = 'sat_cfdi_v33_cfdi_relacionados';
    ...
    public static $xmlDeserializers = [
        '{http://www.sat.gob.mx/cfd/3}CfdiRelacionado' => CfdiRelacionadosModels\CfdiRelacionado::class,
    ];
