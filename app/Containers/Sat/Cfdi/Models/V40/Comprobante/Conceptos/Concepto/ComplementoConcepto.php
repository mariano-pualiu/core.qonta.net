...
use App\Containers\Sat\Cfdi\Values\V40\Elements\Comprobante\Conceptos\Concepto\ComplementoConceptoElement;
...
class ComplementoConcepto extends Model
{
    ...
    protected $collection = 'sat_cfdi_v40_complemento_concepto';
