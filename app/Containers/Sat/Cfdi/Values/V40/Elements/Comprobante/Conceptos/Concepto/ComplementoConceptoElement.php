...
use App\Containers\Sat\Cfdi\Values\V40\Attributes\Comprobante\Conceptos\Concepto\ComplementoConcepto as ComplementoConceptoAttributes;
 ...
 */
class ComplementoConceptoElement extends ElementData
{
    # Elements;
