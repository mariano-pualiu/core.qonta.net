...
namespace App\Containers\Sat\Cfdi\Values\V40\Elements\Comprobante\Conceptos;
...
class ConceptoElement extends ElementData
{
    ...
    protected ConceptoElements\ACuentaTercerosElement $ACuentaTerceros;
    ...
    public function __construct(
        ...
        #[WithCastable(ConceptoAttributes\ObjetoImpAttribute::class)]
        public ConceptoAttributes\ObjetoImpAttribute $ObjetoImp
    )
    {}
}
