...
namespace Architecture\XmlSchemator\Analyzers\Xml\Builders\Transformers;
...
{
    use Traits\SetsSectionName, Traits\SetsContainerName, Traits\SetsModelName, Traits\SetsCollectionName, Traits\SetsFileName, Traits\SetsProperties, Traits\SetsClassNamespacePath, Traits\SetsMethods, Traits\SetsNamespaces, Traits\SetsAttributes, Traits\SetsElements, Traits\SetsParent;
    use SetsXsdNamespace, SetsXsdVersionNumber;

    const FILE_NAME = 'Transformer';
    ...
    public function runCommand()
    {
        ...
        $this->runStatus = Artisan::call('core:xml:generate:transformer:node:element', $params);
    }
}
