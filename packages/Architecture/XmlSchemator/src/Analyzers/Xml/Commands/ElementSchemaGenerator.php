...
class ElementSchemaGenerator extends GeneratorCommand
{
    const FILE_TYPE = 'Schema';
    const SHORT_INDENT = '    ';
    const LONG_INDENT = '        ';
    ...
    protected $name = 'core:xml:generate:value:node:schema';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Create an Schema file for an XSD definition';
     ...
     * @var string
     */
    protected const ROOT = 'schemas/sections';

    /**
     * The structure of the file path.
     */
    protected string $pathStructure = '{SectionName}/{ContainerName}/Schemas/{VersionNumber}/{PathFolder}/*';
    /**
     ...
     */
    protected string $stubName = 'schemas/xsd_element.stub';
