...
namespace Architecture\XmlSchemator\Analyzers\Xml\Deserializers\Traits;
...
trait ModelDeserializerTrait
{
    public static function xmlDeserializer(Reader $reader) {
